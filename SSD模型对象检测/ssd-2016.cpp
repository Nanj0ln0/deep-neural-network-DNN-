...
String labelFile = "D:/OpenCV/Dnn model/SSD2016/labelmap_det.txt";
String modelFile = "D:/OpenCV/Dnn model/SSD2016/VGG_ILSVRC2016_SSD_300x300_iter_440000.caffemodel";
String model_text_file = "D:/OpenCV/Dnn model/SSD2016/deploy.prototxt";
...
int main(int argc, char** argv) {
	Mat frame = imread("D:/OpenCV/picture zone/cat.jpg");
	if (frame.empty()) {
